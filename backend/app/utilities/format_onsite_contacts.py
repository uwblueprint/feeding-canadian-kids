...
def get_meal_request_snippet(meal_request: MealRequest):
    meal_request_snippet = EmailService.read_email_template(
        "email_templates/meal_request_snippet.html"
    ).format(
        ...
        asp_primary_contact=get_onsite_contacts_string(
            [meal_request.requestor.info.primary_contact]
        ),
        ...
        donor_primary_contact=get_onsite_contacts_string(
            [meal_request.donation_info.donor.info.primary_contact]
        ),
        donor_onsite_contacts=get_onsite_contacts_string(
            meal_request.donation_info.donor_onsite_contacts
        ),
