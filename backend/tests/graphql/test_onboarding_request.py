...
def test_approve_onboading_request():
    ...
    approve_request_result = executed.data["approveOnboardingRequest"]["onboardingRequest"]

    assert approve_request_result["id"] == expected_result["id"]
    assert approve_request_result["info"]["contactName"] == expected_result["info"]["contactName"]
    assert approve_request_result["info"]["contactEmail"] == expected_result["info"]["contactEmail"]
    assert approve_request_result["info"]["contactPhone"] == expected_result["info"]["contactPhone"]
