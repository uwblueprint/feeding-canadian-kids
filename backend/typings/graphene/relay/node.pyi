...
class GlobalID(Field):
    ...
    def __init__(self, node: Incomplete | None = None, parent_type: Incomplete | None = None, required: bool = True, *args, **kwargs) -> None: ...
    @staticmethod
    def id_resolver(parent_resolver, node, root, info, parent_type_name: Incomplete | None = None, **args): ...
...
class Node(AbstractNode):
    ...
    @classmethod
    def get_node_from_global_id(cls, info, global_id, only_type: Incomplete | None = None): ...
    @classmethod
