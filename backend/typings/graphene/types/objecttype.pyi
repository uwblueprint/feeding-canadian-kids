...
from .base import BaseOptions as BaseOptions, BaseType as BaseType, BaseTypeMeta as BaseTypeMeta
...
class ObjectType(BaseType, metaclass=ObjectTypeMeta):
    @classmethod
    def __init_subclass_with_meta__(cls, interfaces=(), possible_types=(), default_resolver: Incomplete | None = None, _meta: Incomplete | None = None, **options) -> None: ...
