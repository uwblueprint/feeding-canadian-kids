...
from graphql.language import DefinitionNode as DefinitionNode, FieldNode, FragmentDefinitionNode, Node as Node, OperationDefinitionNode
...
def depth_limit_validator(max_depth: int, ignore: Optional[List[IgnoreType]] = None, callback: Callable[[Dict[str, int]], None] = None): ...
def get_fragments(definitions: List[DefinitionNode]) -> Dict[str, FragmentDefinitionNode]: ...
def get_queries_and_mutations(definitions: List[DefinitionNode]) -> Dict[str, OperationDefinitionNode]: ...
