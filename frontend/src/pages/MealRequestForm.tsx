...
import { Contact, Role } from "../types/UserTypes";
...
const MealRequestForm = () => {
  ...
  const getMobileOnsiteContactSection = (): React.ReactElement => (
  ...
  const getWebOnsiteContactSection = (): React.ReactElement => (
      ...
      >
        ...
        >
          ...
          <ModalBody pb={6}>
            ...
            {isWebView
              ? getWebOnsiteContactSection()
              : getMobileOnsiteContactSection()}
          </ModalBody>
